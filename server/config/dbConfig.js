...
module.exports = function(app){
  ...
  knex.schema.hasTable('diseases').then(function(exists) {
    if (!exists) {
  ...
  knex.schema.hasTable('location').then(function(exists) {
    if (!exists) {
  ...
  knex.schema.hasTable('user_disease').then(function(exists) {
    if (!exists) {
  ...
  knex.schema.hasTable('proximity').then(function(exists) {
    if (!exists) {
